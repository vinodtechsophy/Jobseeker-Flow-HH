...
var CertificationDetails = function (props) {
    ...
    return (_jsx(React.Fragment, { children: _jsxs("div", __assign({ id: "certificationDetails-root-container", className: "certification-div" }, { children: [_jsx("div", __assign({ className: "add-btn-div" }, { children: _jsxs(Button, __assign({ id: "add-certificate-button", className: "next-button", variant: "contained", onClick: function () { return handleServiceAdd(); } }, { children: [_jsx(AddIcon, { className: "add-icon" }), " ", CERTIFICATION_ADD_TEXT] })) })), serviceList.length > 0 &&
                    serviceList.map(function (singleService, index) { return (_jsx("div", __assign({ className: "services" }, { children: _jsx("div", __assign({ className: "first-division" }, { children: _jsxs(StyledContainer, { children: [_jsxs(Grid, __assign({ container: true, className: classes.muiContainer }, { children: [_jsx(Grid, __assign({ item: true, xs: FULL_SIZE_GRID, sm: FULL_SIZE_GRID, md: FULL_SIZE_GRID, lg: FULL_SIZE_GRID, sx: {
                                                    ...
                                                    marginBottom: 1,
                                                            ...
                                                            .issuingOrganization, error: getError("members[".concat(index, "].issuingOrganization")), helperText: getError("members[".concat(index, "].issuingOrganization")) })] })), _jsxs(Grid, __assign({ item: true, xs: FULL_SIZE_GRID, sm: FULL_SIZE_GRID, md: FULL_SIZE_GRID, lg: FULL_SIZE_GRID, mt: 2 }, { children: [_jsx("span", { children: CREDENTIAL_EXPIRY_TEXT }), _jsx(Checkbox, { id: "credential-expiry-status-checkbox", disabled: props.disabled, checked: certificationDetailsForm.values.members[index]
