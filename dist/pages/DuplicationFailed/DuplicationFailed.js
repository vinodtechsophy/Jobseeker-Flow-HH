...
var DuplicationFailed = function () {
  var _a = useState(1),
    selectedButton = _a[0],
    setSelectedButton = _a[1];
  var gridRef = useRef();
  var _b = useState(LISTING_GENERIC_HEADERS),
    columnDefs = _b[0],
    setColumnDefs = _b[1];
  var _c = useState(10),
    pageSize = _c[0],
  ...
  var _g = React.useState(false),
    columnsListOpen = _g[0],
    setColumnsListOpen = _g[1];
  var _h = React.useState(true),
    floatingFilter = _h[0],
    setFloatingFilter = _h[1];
  ...
  var fetchToken = function () {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, KeycloakService.fetchTokenOtherUser()];
          case 1:
            token = _a.sent();
  ...
  var setColumnsDisplay = function (columnList) {
    var newColumnDefs = columnDefs.map(function (colDef) {
      var columnReference = columnList.find(function (col) {
        return col.headerName === colDef.headerName;
      });
      if (columnReference) {
  ...
  return _jsxs(
    Grid,
    __assign(
      { container: true, spacing: 3, rowSpacing: 4 },
      {
        children: [
          _jsx(
            Grid,
            __assign(
              { item: true, xs: 12, p: 2 },
              {
                children: _jsx(
                  ...
                  __assign(
                    { fontSize: 30 },
                    { children: "Previously Failed PDC and FDC Profiles." }
                  )
                ),
              }
            )
                              ...
                              __assign(
                                {
                                  ...
                                  onClick: function () {
                                    return setColumnsListOpen(true);
                                  },
                              ...
                              __assign(
                                {
                                  ...
                                  className: "save-draft-button",
                                  onClick: function () {
                                    return toogleFloatingFilter(
                                      !floatingFilter
                                    );
                                  },
                                  sx: {
                                    background: floatingFilter
                                      ? LIGHT_GREY
                                      : "inherit",
                                  },
                                },
          ...
          _jsx(ColumnSelection, {
            AllColumns: columnDefs.map(function (cl) {
          ...
          _jsx(
            ...
            __assign(
              { item: true, xs: 12 },
              {
                children: _jsx(AgGridWithPagination, {
                  gridRef: gridRef,
                  rowData: row,
