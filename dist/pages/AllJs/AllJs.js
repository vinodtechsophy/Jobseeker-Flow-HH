...
var AllJs = function () {
  var gridRef = useRef();
  var _a = useState(LISTING_GENERIC_HEADERS),
    columnDefs = _a[0],
    setColumnDefs = _a[1];
  var _b = useState(10),
    pageSize = _b[0],
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                contestLinkedJobsekeers("CONTEST_07_10078", 0, 100),
              ];
            case 1:
              response = _a.sent();
              console.log(
            ...
            __assign(
              { item: true, xs: 12, p: 2 },
              {
                children: [
                  _jsx(
                    Typography,
                    __assign({ fontSize: 30 }, { children: "Profile" })
                  ),
                  _jsx(StepCount, {
                    StepCountList: [
                      {
